package com.radical.ipros.ui
{
	...
	public class TargetBar extends MovieClip
	{
		...
		public function init(_kpi:TargetKPIData)
		{
			...
			initialText = _kpi.initialLabel + "\n" + _kpi.initialValue + " " + _kpi.initialUnits;
			targetText = _kpi.targetLabel + "\n" + _kpi.targetValue + " " + _kpi.targetUnits;
			...
			this.InitialValueBlock.setText(_kpi.initialValue + " " + _kpi.initialUnits.toUpperCase());
			this.TargetValueBlock.setText(_kpi.targetValue + " " + _kpi.targetUnits.toUpperCase(), _kpi.additional);
